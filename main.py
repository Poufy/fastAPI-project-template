...
@app.get('/greet/anyone', summary='Greet everyone', description='This is a description for the greet everyone route', response_description='This is the response description')
def greet():
